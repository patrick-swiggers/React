    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Footer>
                    <button onClick={props.toggleShow} className="bg-slate-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Close</button>
                    <button className="bg-purple-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" form='editmodal'>Add</button>
